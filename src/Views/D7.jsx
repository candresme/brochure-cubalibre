    ...
    <div className="container-fluid text-center m-0 p-0">
        <Bounce left cascade>
            ...
            <div className="row p-0 m-0 align-items-center justify-content-between" style={{backgroundImage: `url(${fondo})`, backgroundPosition: 'center',backgroundSize: 'cover'}}>
                ...
                <div className='col-md col-sm-12 m-0 p-0 order-sm-0 order-md-1' style={{height: '100%', width: '100%'}}>
                    ...
                    <div className="row align-items-center justify-content-center text-center m-4">
                        ...
                        <div className="col-md-12 col-sm-12 m-2">
                            <div className="row align-items-center justify-content-center text-center">
                                <img className="col-sm-2 col-md-1" src={location} alt=""/>
                                <h1 className="col-6 text-start" style={{backgroundColor: '#F39204', borderRadius: '10px', padding: '5px'}}>Santiago de Cali</h1>
                            </div>
                            <div className="row align-items-center justify-content-center text-center">
                        ...
                        <div className="col-md-12 col-sm-12 m-2">
                            <div className="row align-items-center justify-content-center text-center">
                                <img className="col-sm-2 col-md-1" src={location} alt=""/>
                                <h1 className="col-6 text-start" style={{backgroundColor: '#F39204', borderRadius: '10px', padding: '5px'}}>Bogotá</h1>
                            </div>
                            <div className="row align-items-center justify-content-center text-center">
                                <div className="col-sm-2 col-md-1"></div>
                                <p className="col-6">
                        ...
                        <div className="col-md-12 col-sm-12 m-2">
                            <div className="row align-items-center justify-content-center text-center">
                                <img className="col-sm-2 col-md-1" src={location} alt=""/>
                                <h1 className="col-6 text-start" style={{backgroundColor: '#F39204', borderRadius: '10px', padding: '5px'}}>Medellín</h1>
                            </div>
                            <div className="row align-items-center justify-content-center text-center">
                                <div className="col-sm-2 col-md-1"></div>
                                <p className="col-6">
                        ...
                        <div className="col-md-12 col-sm-12 m-2">
                            <div className="row align-items-center justify-content-center text-center">
                                <img className="col-sm-2 col-md-1" src={location} alt=""/>
                                <h1 className="col-6 text-start" style={{backgroundColor: '#F39204', borderRadius: '10px', padding: '5px'}}>Bucaramanga</h1>
                            </div>
                            <div className="row align-items-center justify-content-center text-center">
                                <div className="col-sm-2 col-md-1"></div>
                                <p className="col-6">
                        ...
                        <div className="col-md-12 col-sm-12 m-2">
                            <div className="row align-items-center justify-content-center text-center">
                                <img className="col-sm-2 col-md-1" src={location} alt=""/>
                                <h1 className="col-6 text-start" style={{backgroundColor: '#F39204', borderRadius: '10px', padding: '5px'}}>Cartagena</h1>
                            </div>
                            <div className="row align-items-center justify-content-center text-center">
                                <div className="col-sm-2 col-md-1"></div>
                                <p className="col-6">
                        ...
                        <div className="col-md-12 col-sm-12 m-2">
                            <div className="row align-items-center justify-content-center text-center">
                                <img className="col-sm-2 col-md-1" src={location} alt=""/>
                                <h1 className="col-6 text-start" style={{backgroundColor: '#F39204', borderRadius: '10px', padding: '5px'}}>Santa Marta</h1>
                            </div>
                            <div className="row align-items-center justify-content-center text-center">
                                <div className="col-sm-2 col-md-1"></div>
                                <p className="col-6">
