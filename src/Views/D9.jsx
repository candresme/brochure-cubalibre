        ...
        <div className="row align-items-center justify-content-center m-0 p-0" style={{backgroundImage: `url(${fondo})`, backgroundPosition: 'center',backgroundSize: 'cover'}}>
            <Bounce left cascade>
                <div className='col-12'>
                    <img className="m-0 p-0" src={titulo} alt="" width='50%'/>
                </div>

                <div className='row justify-content-center align-items-center'>

                        <div className="col-md-4 p-2 ">
                            <p className="text-center p-0 m-0" style={{color: 'white'}}>De borondo con Cesar Mora</p>
                        ...
                        <div className="col-md-4 p-2">
                            <p className="text-center p-0 m-0" style={{color: 'white'}}>El Swing - España</p>
                        ...
                        <div className="col-md-4 p-2">
                            <p className="text-center p-0 m-0" style={{color: 'white'}}>Kien y Ke</p>   
                        ...
                        <div className="col-md-4 p-2">
                            <p className="text-center p-0 m-0" style={{color: 'white'}}>Resonantes Canal Trece</p>
                        ...
                        <div className="col-md-4 p-2">
                            <p className="text-center p-0 m-0" style={{color: 'white'}}>Salseros VIP</p>
                        ...
                        <div className="col-md-4 p-2">
                            <p className="text-center p-0 m-0" style={{color: 'white'}}>Trendiendo Canal RCN</p>
                ...
                <div className='col-12 text-end'>
                    <img className="m-0 p-0 align-self-end" src={imagen} alt="" width='15%'/>
                </div>
